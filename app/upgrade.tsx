...
export default function UpgradeScreen() {
  ...
  return (
    ...
    <View className="flex-1 bg-slate-900">
      ...
      {/* Đây chỉ là hình ảnh để gợi ý người dùng vuốt, logic vuốt do _layout lo */}
      <View
      ...
      {/* 2. NÚT ĐÓNG (Vẫn nên giữ lại cho người dùng Android hoặc ai không quen vuốt) */}
      <TouchableOpacity
        onPress={() => router.back()}
      ...
      {/* 3. NỘI DUNG CHÍNH */}
      <ScrollView
        className="flex-1 bg-white rounded-t-[32px] overflow-hidden mt-1"
        showsVerticalScrollIndicator={false}
        contentContainerStyle={{ paddingBottom: 40 }}
        // Quan trọng: bounciness giúp cảm giác vuốt trên iOS tự nhiên hơn
        bounces={true}
      >
        {/* Header Banner */}
        <View className="bg-slate-900 pt-12 pb-14 px-6 items-center relative overflow-hidden">
        ...
        <View className="px-6 -mt-8">
          <View className="bg-white p-6 rounded-[32px] shadow-2xl shadow-slate-900/10 border border-slate-100">
            <View className="flex-row justify-between items-center mb-6">
              ...
              <View className="bg-orange-100 px-3 py-1 rounded-full">
                <Text className="text-orange-600 font-bold text-xs">-20%</Text>
              </View>
            </View>
            ...
            <TouchableOpacity className="bg-orange-500 w-full py-4 rounded-2xl items-center shadow-lg shadow-orange-300 active:bg-orange-600">
        ...
        <View className="px-6 py-8 pb-32">
          <Text className="text-center text-slate-800 font-bold text-lg mb-6">
            Học viên nói gì?
          </Text>
          <View className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
            ...
            <Text className="text-slate-600 italic leading-6 mb-4">
            ...
            <View className="flex-row items-center">
              <View className="w-8 h-8 bg-blue-200 rounded-full items-center justify-center mr-2">
                <Text className="font-bold text-blue-700 text-xs">M</Text>
              </View>
              <Text className="text-slate-900 font-bold text-sm">Minh Anh</Text>
            </View>
          </View>
        </View>
      </ScrollView>
